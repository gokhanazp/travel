export const toursData = [
  // New Tours - Our Main Accessible Istanbul Tours
  {
    ...
    accessibility: "Tam erişilebilir",
    accessibilityEn: "Fully accessible",
    price: 450,
    priceEn: 450,
    currency: "€",
    currencyEn: "€",
    ...
    itinerary: [
      {
        ...
        descriptionEn: "Your private guide and driver will pick you from airport with special designed van for wheelchair users and take you to your hotel.<br><br>The rest of the day is on your own.<br>Overnight in accessible-friendly hotel in İstanbul."
      },
      {
        day: 2,
        title: "İstanbul (Tekerlekli Sandalye ile)",
        titleEn: "Istanbul (With Wheelchair)",
        description: "Özel rehberiniz sizi lobide karşılayacak ve tekerlekli sandalye ile yürüyüş turuna başlayacaksınız. Antik Hipodrom - bir zamanlar Bizans Konstantinopolis'in merkezi, araba yarışları ve siyasi toplantılarla ünlü. Büyük açık meydan, tamamen tekerlekli sandalye erişilebilir. Sonra Topkapı Sarayı'na gidiyoruz - Osmanlı İmparatorluğu'nun büyük sarayı, yaklaşık 400 yıl Osmanlı padişahlarının yönetim yeri. Burada imparatorluk avlularını ve hazineleri göreceğiz. Çoğu alan erişilebilir, rehberimizle rampalar kullanarak bölümleri keşfedeceğiz. Saraydan sonra Sultanahmet Camii'ni ziyaret ediyoruz - 1609-1616 yılları arasında Sultan Ahmet tarafından inşa edildi. İç duvarlarındaki güzel İznik çinileri nedeniyle Mavi Cami olarak bilinir. Nefes kesen tasarımı, 200 yıllık Osmanlı cami mimarisi ile Bizans kilise mimarisinin sentezi. Engelliler için tasarlanmış rampalar kullanarak caminin ana alanına gireceğiz. İçeride halı tekerlekli sandalyeleri biraz yavaşlatabilir. Erişilebilir yerel restoranda öğle yemeği. Öğle yemeği molasından sonra alışveriş için serbest zaman için Kapalıçarşı'ya yürüyoruz. Bu, 15. yüzyılda kurulan dünyanın en eski ve en büyük kapalı çarşılarından biri, binlerce dükkanı var. Burada Kapalıçarşı'yı tekerlekli sandalye dostu rotada, düz ana yolları seçerek geziyoruz. Burada alışveriş yapabilir veya sadece atmosferi hissedebilirsiniz. İstanbul'da engelli dostu otelimize dönüyoruz.",
        descriptionEn: "Your private guide meet you in the lobby and you will begin your walking tour with wheelchair with the Ancient<br><br>Hippodrome once the center of Byzantine Constantinople, famous for chariot races and political gatherings. İt is large open square, fully wheelchair accessible.<br>Next we are heading to the Topkapı Palace, The grand palace of the Ottoman Empire ,ruling place of the Ottoman Empire and the seat of the Ottoman sultans about 4oo years. Here we will see the imperial courtyards and treasures. Most areas are accessible, we will explore the sections using ramps with our guide.<br>After the palace we visit the Blue Mosque, It was built between the years 1609-1616 by Sultan Ahmet. İt is known as Blue Mosque because its beautiful İznik tiles on interior walls.. Its breathtaking design is the synthesis of 200-year-old of Ottoman mosque architecture with Byzantine church architecture. We will enter the main area of the mosque using ramps designed for disabled people.İnside, the carpet may slow wheelchairs slightly.<br><br>Lunch at an accessible local restaurant.<br>After lunch break, we walk to the Grand Bazaar for free time for shopping. This is one of the world's oldest and largest covered bazaars founded in the 15th century, it has thousands of shops. Here we will tour the Grand Bazaar on a wheelchair-friendly route, choosing flat main<br><br>roads. Here you can enjoy shopping or just feel the atmosphere.<br><br>We return to our disabled friendly hotel for the night in İstanbul."
      },
      {
        day: 3,
        title: "İstanbul (Tekerlekli Sandalye ile)",
        titleEn: "İstanbul ( With Wheelchair )",
        description: "Bugün Ayasofya'yı ziyaret ederek yürüyüş turumuza başlayacağız. İstanbul'un en eski tarihi binası, 1000 yıl Bizans İmparatorluğu'nun büyük katedrali ve 500 yıl Osmanlı İmparatorluğu'nun büyük camii olarak kullanıldı. Tekerlekli sandalye kullanıcıları için aldığımız izinle muhteşem ana alanı ziyaret edeceğiz. Zemin kat erişilebilir, ancak galeriler değil - yine de ana salon nefes kesici. Sonra Konstantinopolis'in su deposu olan 1500 yıllık Yerebatan Sarnıcı'nı ziyaret etmek için yürümeye devam edeceğiz. Bir zamanlar şehir için su depoluyordu, aynı zamanda Bizans döneminden. Yakın zamanda restore edildi, sarnıç çok basamaklı merdivenle erişilebilir olsa da, tekerlekli sandalye erişimi içeride özel bir asansörle sağlanıyor. Bizans Sarnıcı'nı gördükten sonra sahil kenarındaki Haliç'e doğru yürümeye devam edeceğiz. Sahil kenarında erişilebilir yerel restoranda öğle yemeği. Öğle yemeğinden sonra İstanbul'un güzelliğinin tadını çıkarmak için yaklaşık 1,5 saat süren Boğaz turumuz için feribota bineceğiz. Gemi seyri sırasında bir tarafta Avrupa kıtasını, diğer tarafta Asya kıtasını ve 18. yüzyıldan kalma İstanbul'un güzel yalılarını Boğaz Köprüleri ile birlikte görme şansınız olacak. Bu deneyim oldukça görsel ve işitme engelli misafirler için mükemmel. Gemi seyirinden sonra limandan otelimize dönüyoruz. İstanbul'da geceleme.",
        descriptionEn: "Today we will start our walking tour by vising Hagia Sophia. The oldest historical building in İstanbul which was used 1000 years as a grand cathedral of Byzantine Empire and 500 years as a grand mosque of the Ottoman Empire. we will visit the main magnificent area with a permission we received for the wheelchair users. The ground floor is accessible, but the galleries are not- still the main hall is breathtaking.<br><br>Then we will continue walking to visit 1500 years old Underground Cistern which was the water reservour of Constantinopolis. İt once stored water for the city, also from the Byzantine period. Recently restored, while the cistern is accessible via multi-step staircase, wheelchair access is provided by a dedicated lift inside.<br><br>After seeing the Byzantine Cistern we will keep walking down to the seaside Golden Horn.<br>Lunch at accessible local restaurant by the seaside.<br><br>After Lunch we will board the ferry for our Bosphorus tour which takes about 1.5 hours to enjoy the beauty of İstanbul. During the cruise, you will have chance to see the European continent on one side, the Asian continent on the other and the beautiful mansions of İstanbul from the 18th century together with Bosphorus Bridges. This experience is highly visual and perfect for hearing- impaired guests.<br>After the cruise we return to our hotel from the port.<br>Overnight in İstanbul."
      },
      {
        day: 4,
        title: "İstanbul (Özel Araçla)",
        titleEn: "Istanbul ( With Private Van )",
        description: "Özel rehber ve şoföriniz sizi otelde karşılayacak. İlk ziyaretimiz Boğaz kenarında inşa edilmiş Osmanlı İmparatorluğu'nun ikinci sarayı Dolmabahçe Sarayı. Osmanlı padişahlarının son ikametgahı ve aynı zamanda Mustafa Kemal Atatürk'ün son günlerini geçirdiği yer. Sarayı ziyaret ettikten sonra Boğaz Köprüsü'nden geçerek İstanbul'un Asya yakasına gidiyoruz. Buradaki ilk durağımız Boğaz'ın en yüksek noktası olan Çamlıca Tepesi. Buradan Boğaz'ın güzelliğini kuş bakışı izleyebilirsiniz. Burada izleme terasları tekerlekli sandalye erişilebilir, rampalar ve düz yürüyüşler var. Daha sonra İstanbul'un Asya yakasındaki en büyük kasaba olan Kadıköy ilçesine gidiyoruz. Deniz kenarında kısa bir yürüyüşten sonra Kadıköy'ün eski pazarını ziyaret edeceğiz. Burada Kokoreç (ızgara kuzu bağırsağı), Midye Dolma (Dolma Midye), Midye Tava (Izgara Midye), Çiğ Köfte (Çiğ Köfte), Ayran (yoğurttan yapılan geleneksel Türk içeceği) gibi Türk sokak lezzetlerini görebilirsiniz. Bir kafede Türklerle birlikte Türk kahvesi veya Türk çayı deneyimi yaşayabilirsiniz. Yerel restoranda öğle yemeği. Öğle yemeğinden sonra Boğaz Köprüsü'nden geçerek Avrupa yakasına dönüyoruz. Bugün son durağımız Mısır Çarşısı olacak. Bu, Kapalıçarşı'dan sonra İstanbul'un en eski pazarlarından biri, 17. yüzyılda inşa edilmiş. Pazar düz ve gezinmesi kolay, renkli baharatlar, tatlılar ve bitki çayları ile dolu. Turumuz Mısır Çarşısı / Mısır Çarşısı'nı ziyaret ettikten sonra sona eriyor ve otele dönüyoruz. İstanbul'da geceleme.",
        descriptionEn: "Your private guide and driver will meet you at the hotel. Our first visit is Dolmabahçe Palace the second palace of the Ottoman Empire, built on the edge of the Bosphorus. It was the last residence of Ottoman sultans and also where Mustafa Kemal Atatürk spent his final days.<br>After visiting the palace we are driving across the Bosphorus Bridge and going to the Asian side of İstanbul. Our first stop here is Çamlıca Hill which is the highest point of the Bosphorus. From here you can watch the beauty of the Bosphorus from a bird's eye view. Here viewing terraces are wheelchair-accessible, with ramps and smooth walks.<br><br>Later we drive to Kadıkoy district, which is the largest town on the Asian part of İstanbul. After a short walk by the sea, we will visit the old market of Kadıkoy. Here you can see Turkish Street delicacies such as Kokorec (grilled lamb's intestine), Midye Dolma (Stuffed Mussels), Midye tava ( Grilled Mussels), Çiğ Kofte( Raw Meatballs), Ayran (traditional Turkish drink made by yoghurt). You can experience Turkish coffee or Turkish tea with Turks in a cafe.<br>Lunch in a Local Restaurant.<br>After lunch, we drive over the Bosphorus Bridge and come back to the European side.<br>Today our last stop will be the Spice Bazaar. This is one of the oldest market in İstanbul after the Grand Bazaar built in the 17th century. The market is flat and easy to navigate, filled with colorful spices, sweets and herbal teas.<br>Our tour ends after visiting the Spice Market / Egyptian Bazaar and we return to the hotel.<br>Overnight in İstanbul."
      },
      {
        day: 5,
        title: "Ayrılış",
        ...
        descriptionEn: "Your driver will pick you up at your hotel with private accessible vehicle and take you to the Istanbul Airport for your return international flight.<br><br>Time to say goodbye to Istanbul<br>End of the tour .."
      }
    ],
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-01-20",
        comment: "Incredible experience! Every detail was perfectly planned for wheelchair accessibility. Our guide was amazing!",
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-01-15",
        comment: "Perfect 4-day tour! Everything was wheelchair accessible and our guide was incredibly knowledgeable.",
        commentEn: "Perfect 4-day tour! Everything was wheelchair accessible and our guide was incredibly knowledgeable.",
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-01-10",
        comment: "Amazing one-day tour! Every location was perfectly accessible and our guide was fantastic!",
        commentEn: "Amazing one-day tour! Every location was perfectly accessible and our guide was fantastic!",
