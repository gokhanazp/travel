    ...
    itinerary: [
      {
        ...
        descriptionEn: "Your private guide and driver will pick you from airport\nwith special designed van for wheelchair users and take\nyou to your hotel.\nThe rest of the day is on your own.\nOvernight in accessible-friendly hotel in İstanbul."
      },
      {
        day: 2,
        ...
        descriptionEn: "Your private guide meet you in the lobby and you will\nbegin your walking tour with wheelchair with the Ancient\n\nHippodrome once the center of Byzantine\nConstantinople, famous for chariot races and political\ngatherings. İt is large open square, fully wheelchair\naccessible.\nNext we are heading to the Topkapı Palace, The grand\npalace of the Ottoman Empire ,ruling place of the\nOttoman Empire and the seat of the Ottoman sultans\nabout 4oo years. Here we will see the imperial\ncourtyards and treasures. Most areas are accessible, we\nwill explore the sections using ramps with our guide.\nAfter the palace we visit the Blue Mosque, It was built\nbetween the years 1609-1616 by Sultan Ahmet. İt is\nknown as Blue Mosque because its beautiful İznik tiles\non interior walls.. Its breathtaking design is the\nsynthesis of 200-year-old of Ottoman mosque\narchitecture with Byzantine church architecture. We\nwill enter the main area of the mosque using ramps\ndesigned for disabled people.İnside, the carpet may slow\nwheelchairs slightly.\n\nLunch at an accessible local restaurant.\nAfter lunch break, we walk to the Grand Bazaar for free\ntime for shopping. This is one of the world's oldest and\nlargest covered bazaars founded in the 15th century, it\nhas thousands of shops. Here we will tour the Grand\nBazaar on a wheelchair-friendly route, choosing flat main\n\nroads. Here you can enjoy shopping or just feel the\natmosphere.\n\nWe return to our disabled friendly hotel for the night in\nİstanbul."
      },
      {
        day: 3,
        title: "İstanbul (Tekerlekli Sandalye ile)",
        ...
        descriptionEn: "Today we will start our walking tour by vising Hagia\nSophia. The oldest historical building in İstanbul which\nwas used 1000 years as a grand cathedral of Byzantine\nEmpire and 500 years as a grand mosque of the\nOttoman Empire. we will visit the main magnificent area\nwith a permission we received for the wheelchair users.\nThe ground floor is accessible, but the galleries are not-\nstill the main hall is breathtaking.\n\nThen we will continue walking to visit 1500 years old\nUnderground Cistern which was the water reservour of\nConstantinopolis. İt once stored water for the city, also\nfrom the Byzantine period. Recently restored, while the\ncistern is accessible via multi-step staircase, wheelchair\naccess is provided by a dedicated lift inside.\n\nAfter seeing the Byzantine Cistern we will keep walking\ndown to the seaside Golden Horn.\nLunch at accessible local restaurant by the seaside.\n\nAfter Lunch we will board the ferry for our Bosphorus\ntour which takes about 1.5 hours to enjoy the beauty of\nİstanbul. During the cruise, you will have chance to see\nthe European continent on one side, the Asian continent\non the other and the beautiful mansions of İstanbul from\nthe 18th century together with Bosphorus Bridges. This\nexperience is highly visual and perfect for hearing-\nimpaired guests.\nAfter the cruise we return to our hotel from the port.\nOvernight in İstanbul."
      },
      {
        day: 4,
        ...
        descriptionEn: "Your private guide and driver will meet you at the hotel.\nOur first visit is Dolmabahçe Palace the second palace\nof the Ottoman Empire, built on the edge of the\nBosphorus. It was the last residence of Ottoman sultans\nand also where Mustafa Kemal Atatürk spent his final\ndays.\nAfter visiting the palace we are driving across the\nBosphorus Bridge and going to the Asian side of\nİstanbul. Our first stop here is Çamlıca Hill which is the\nhighest point of the Bosphorus. From here you can\nwatch the beauty of the Bosphorus from a bird's eye\nview. Here viewing terraces are wheelchair-accessible,\nwith ramps and smooth walks.\n\nLater we drive to Kadıkoy district, which is the largest\ntown on the Asian part of İstanbul. After a short walk by\nthe sea, we will visit the old market of Kadıkoy. Here you\ncan see Turkish Street delicacies such as Kokorec\n(grilled lamb's intestine), Midye Dolma (Stuffed Mussels),\nMidye tava ( Grilled Mussels), Çiğ Kofte( Raw\nMeatballs), Ayran (traditional Turkish drink made by\nyoghurt). You can experience Turkish coffee or Turkish\ntea with Turks in a cafe.\nLunch in a Local Restaurant.\nAfter lunch, we drive over the Bosphorus Bridge and\ncome back to the European side.\nToday our last stop will be the Spice Bazaar. This is one\nof the oldest market in İstanbul after the Grand Bazaar\nbuilt in the 17th century. The market is flat and easy to\nnavigate, filled with colorful spices, sweets and herbal\nteas.\nOur tour ends after visiting the Spice Market / Egyptian\nBazaar and we return to the hotel.\nOvernight in İstanbul."
      },
      {
        day: 5,
        title: "Ayrılış",
        ...
        descriptionEn: "Your driver will pick you up at your hotel with private\naccessible vehicle and take you to the Istanbul Airport\nfor your return international flight.\n\nTime to say goodbye to Istanbul\nEnd of the tour .."
      }
    ],
    reviews: [
      {
