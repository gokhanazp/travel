        ...
        {isMenuOpen && (
          <div className="lg:hidden py-4 border-t border-gray-200">
            <div className="space-y-2">
              ...
              <a href="/#testimonials" className="block px-4 py-2 text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-lg transition-colors">
                Yorumlar
              </a>
              <a href="/#contact" className="block px-4 py-2 text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-lg transition-colors">
                İletişim
              </a>
              <div className="px-4 pt-2">
                <Link 
                  to="/rezervasyon"
                  className="w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition-colors font-medium block text-center"
                >
                  Rezervasyon Yap
                </Link>
              </div>
