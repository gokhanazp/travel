    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <span className="inline-flex items-center px-6 py-3 rounded-full text-sm font-medium bg-gradient-to-r from-orange-100 to-orange-200 text-orange-800 mb-6">
          ...
          <h2 className="text-5xl font-bold text-gray-900 mb-6 leading-tight">
            {t('tourParticipants')}
            <span className="bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent"> {t('ourGuests')}</span>
          </h2>
