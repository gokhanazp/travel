...
const translations = {
  en: {
    ...
    toursSubtitle:
      "Discover our most popular destinations and create unforgettable memories",
    ...
    expertGuidesFeaturesList: [
      "8+ years experience",
      "Professional certification",
      "Specialized training",
      "Emergency response",
    ],
    specialVehiclesFeaturesList: [
      "Hydraulic lift systems",
      "Safety equipment",
      "Climate control",
      "Professional drivers",
    ],
    personalizedServiceFeaturesList: [
      "Individual planning",
      "Flexible itinerary",
      "Medical support",
      "24/7 assistance",
    ...
    photoGallerySubtitle:
      "Happy moments and unforgettable experiences of our guests who participated in our accessible tours",
    ...
    vehicleFeaturesTitle:
      'Our <span class="text-orange-500">Specialized</span> Vehicle Fleet',
    vehicleFeaturesSubtitle:
      "Modern and specially equipped vehicles designed to provide safe, comfortable and accessible transportation for all our guests.",
    ...
    turkeyFirstCompany: "A Leading Accessible Travel Agency in Turkey",
    comfortDescription:
    ...
    aboutUsHomeTitle:
      'A <span class="text-orange-500">Leading</span> Accessible Travel Agency<br/>in Turkey',
    aboutUsHomeSubtitle:
      "Specially designed for people with disabilities, elderly, and those with limited mobility",
    aboutUsDescription:
      "As Piba Wings Mobility, we are a leading travel agency in Turkey, offering specially designed tours and professional team to make life easier for people with disabilities, the elderly, people with limited mobility, and those with hearing impairments.",
    ourMission: "Our Mission",
    missionText:
      "To eliminate travel barriers and make the world accessible to everyone, regardless of physical limitations. We believe accessible tourism will grow and individuals with disabilities will be seen more frequently in historical sites and museums.",
    ...
    about_subtitle: "A leading accessible travel agency in Turkey",
    about_desc_1:
      "As Piba Wings Mobility, we are dedicated to breaking down barriers and making travel a reality for everyone. We specialize in creating custom tour experiences for individuals with disabilities, seniors, and those with limited mobility.",
    about_desc_2:
      "Our mission is to provide safe, comfortable, and enriching travel experiences. From fully accessible vehicles to meticulously planned itineraries and professional, caring guides, we handle every detail to ensure a worry-free journey.",
    about_desc_3:
      "We believe that the joy of discovery should be accessible to all. Join us to explore the rich history and vibrant culture of Turkey without limits.",
    about_meet_founder: "About Our Founder",
    ...
    footerCopyright: "© 2026 pibawingsmobility.com. All rights reserved.",
  ...
  tr: {
    ...
    toursSubtitle:
      "En popüler destinasyonlarımızı keşfedin ve unutulmaz anılar biriktirin",
    ...
    // Feature Lists
    accessibilityFeaturesList: [
      "Tekerlekli sandalye erişimli mekanlar",
      "Engelsiz ulaşım",
    ...
    photoGallerySubtitle:
      "Erişilebilir turlarımıza katılan misafirlerimizin mutlu anları ve unutulmaz deneyimleri",
    ...
    vehicleFeaturesTitle:
      '<span class="text-orange-500">Özel Donanımlı</span> Araç Filomuz',
    vehicleFeaturesSubtitle:
      "Tüm misafirlerimiz için güvenli, konforlu ve erişilebilir ulaşım sağlamak üzere tasarlanmış modern ve özel donanımlı araçlarımız.",
    ...
    turkeyFirstCompany: "Türkiye'nin Önde Gelen Erişilebilir Seyahat Acentesi",
    comfortDescription:
    ...
    aboutUsHomeTitle:
      'Türkiye\'nin <span class="text-orange-500">Önde Gelen</span><br/>Erişilebilir Seyahat Acentesi',
    aboutUsHomeSubtitle:
      "Engelli bireyler, yaşlılar ve hareket kabiliyeti kısıtlı kişiler için özel olarak tasarlandı",
    aboutUsDescription:
      "Piba Wings Mobility olarak, Türkiye'nin önde gelen seyahat acentesi olarak, engelli bireyler, yaşlılar, hareket kabiliyeti kısıtlı kişiler ve işitme engelliler için özel olarak tasarlanmış turlar ve profesyonel bir ekip sunuyoruz.",
    ourMission: "Misyonumuz",
    missionText:
      "Seyahat engellerini ortadan kaldırmak ve fiziksel sınırlamalar ne olursa olsun dünyayı herkes için erişilebilir kılmak. Erişilebilir turizmin büyüyeceğine ve engelli bireylerin tarihi mekanlar ve müzelerde daha sık görüleceğine inanıyoruz.",
    ...
    about_subtitle: "Türkiye’nin lider erişilebilir seyahat acentesi",
    about_desc_1:
      "Piba Wings Mobility olarak, engelleri kaldırmaya ve seyahati herkes için bir gerçeğe dönüştürmeye adadık. Engelli bireyler, yaşlılar ve hareket kabiliyeti kısıtlı olanlar için özel tur deneyimleri yaratmada uzmanız.",
    about_desc_2:
      "Misyonumuz güvenli, konforlu ve zenginleştirici seyahat deneyimleri sunmaktır. Tam erişilebilir araçlardan titizlikle planlanmış güzergahlara ve profesyonel, ilgili rehberlere kadar, endişesiz bir yolculuk sağlamak için her ayrıntıyı biz hallediyoruz.",
    about_desc_3:
      "Keşfetmenin keyfinin herkese açık olması gerektiğine inanıyoruz. Türkiye'nin zengin tarihini ve canlı kültürünü sınırsızca keşfetmek için bize katılın.",
    about_meet_founder: "Kurucumuz Hakkında",
    ...
    footerSocialMedia:
      "Güncel turlar ve özel teklifler için sosyal medya hesaplarımızı takip edin.",
    ...
    footerCopyright: "© 2026 pibawingsmobility.com. Tüm hakları saklıdır.",
