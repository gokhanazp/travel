                ...
                <div>
                  ...
                  {tour.extraServices && tour.extraServices.length > 0 ? (
                    <div className="space-y-8">
                      ...
                      {[...tour.extraServices]
                        .sort((a, b) => {
                          const isMedical = (s) => /medical|tıbbi/i.test(`${s.titleEn || ''} ${s.title || ''}`)
                          return (isMedical(a) ? 1 : 0) - (isMedical(b) ? 1 : 0)
                        })
                        .map((service, index) => (
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                              {category.photos.map((image, photoIndex) => {
                                ...
                                >
                                  ...
                                  <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-300 ${isVideo ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}>
        ...
        return (
          ...
          >
            <div className="relative max-w-4xl max-h-full">
              ...
              {/* Image / Video */}
              {/\.(mp4|webm|mov)$/i.test(allPhotos[selectedImage]) ? (
                <video
