            ...
            {toursData.map((tour, index) => (
              ...
              >
                ...
                <div className="relative h-72 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className="px-3 py-1 rounded-full text-xs font-bold backdrop-blur-sm bg-green-100 text-green-800">
                ...
                <div className="p-6">
                  ...
                  <div className="bg-gradient-to-r from-orange-50 to-pink-50 rounded-xl p-4 mb-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="text-xs text-gray-600 block">{t('price')}</span>
                        <span className="text-2xl font-bold text-orange-600">
                          €{tour.price}
                        </span>
                        <span className="text-xs text-gray-500 ml-1">{t('perPerson')}</span>
                      </div>
                      <div className="text-right">
                        <div className="flex items-center text-yellow-500 mb-1">
                          {'★'.repeat(5)}
                        </div>
                        <span className="text-xs text-gray-600">4.9 (120+ {t('reviews')})</span>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Highlights */}
                  <div className="mb-6">
                    <h4 className="font-bold text-gray-900 mb-3 text-sm">{t('highlights')}:</h4>
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2">
                  <Link
                    to="/reservation?tour=PBWAI0020"
                    className="flex-1 bg-gradient-to-r from-orange-500 to-red-500 text-white font-semibold py-2 px-4 rounded-full hover:from-orange-600 hover:to-red-600 transform hover:scale-105 transition-all duration-300 text-sm text-center"
                  >
                    {t('bookNow')}
                  </Link>
                  <Link
